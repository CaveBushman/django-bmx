...
class EventInvoice():
    def __init__(self, ):
        ...
        # Registrace fontů
        _BASE_FONT_PATH = os.path.join("static", "fonts")
        pdfmetrics.registerFont(TTFont("DejaVuSans", os.path.join(_BASE_FONT_PATH, "DejaVuSans.ttf")))
        pdfmetrics.registerFont(TTFont("DejaVuSans-Bold", os.path.join(_BASE_FONT_PATH, "DejaVuSans-Bold.ttf")))

    def delete_invoice(self, event, club):
        pass
    ...
    def generate_pdf(self, invoice_data):
        ...
        c.drawString(20 * mm, y_table,
                     "Dovolujeme si Vás upozornit, že v případě nedodržení data splatnosti může být účtován zákonný úrok z prodlení.")
    ...
    def export_invoices(self):
        """ Funcrtion for export *.xml file for accounting"""
        pass
