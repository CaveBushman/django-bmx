...
PRIMARY_STATS = [
    ...
    ("best_result", _("Best result"), 0, ""),
    ("median_result", _("Median result"), 1, ""),
    ("median_finish_time", _("Median finish"), 3, " s"),
    ("median_hill_time", _("Median hill"), 3, " s"),
    ("median_split_1", _("Median split 1"), 3, " s"),
    ("best_finish_time", _("Best finish"), 3, " s"),
    ("best_hill_time", _("Best hill"), 3, " s"),
    ("best_split_1", _("Best split 1"), 3, " s"),
]
...
DETAIL_SECTIONS = [
    (
        ...
        [
            ...
            ("progression_rate", _("Progression rate"), 0, "%"),
            ("average_moto_place", _("Průměr moto place"), 2, ""),
            ("average_final_place", _("Průměr final place"), 2, ""),
    ...
    (
        _("Časy a start"),
        [
            ("average_finish_time", _("Average finish"), 3, " s"),
            ("finish_time_stddev", _("Finish stddev"), 3, " s"),
            ("average_hill_rank", _("Average hill rank"), 2, ""),
            ("hill_win_rate", _("Hill win rate"), 0, "%"),
            ("hill_top3_rate", _("Hill top3 rate"), 0, "%"),
            ("average_positions_gained_after_hill", _("Pozice gained after hill"), 2, ""),
            ("hill_rankable_runs_count", _("Hill rankable runs"), 0, ""),
            ("best_hill_lane", _("Best hill lane"), None, ""),
            ("best_hill_lane_median", _("Best hill lane median"), 3, " s"),
        ],
    ),
    (
        _("Skóre a profil"),
        [
            ("conversion_score", _("Conversion score"), 0, "%"),
            ("recovery_score", _("Recovery score"), 0, "%"),
            ("pressure_score", _("Pressure score"), 0, ""),
            ("pressure_delta", _("Pressure delta"), 2, ""),
            ("track_affinity_score", _("Track affinity score"), 0, ""),
            ("track_affinity_delta", _("Track affinity delta"), 2, ""),
            ("track_affinity_label", _("Track affinity"), None, ""),
            ("stability_score", _("Stability score"), 0, ""),
            ("risk_score", _("Risk score"), 0, ""),
            ("consistency_score", _("Consistency score"), 0, ""),
            ("consistency_label", _("Consistency"), None, ""),
        ],
    ),
    (
        _("Spolehlivost a peer group"),
        [
            ("bad_status_count", _("Bad status count"), 0, ""),
            ("clean_run_rate", _("Clean run rate"), 0, "%"),
            ("pace_index", _("Pace index"), 1, ""),
            ("peer_group_size", _("Peer group size"), 0, ""),
            ("peer_place_percentile", _("Peer place percentile"), 0, "%"),
            ("peer_finish_percentile", _("Peer finish percentile"), 0, "%"),
            ("trend_label", _("Trend"), None, ""),
            ("trend_delta", _("Trend delta"), 3, " s"),
            ("trend_detail", _("Trend detail"), None, ""),
...
def build_rider_premium_stats_pdf(rider, track, track_stats, kpi_period):
    ...
    pdf.setTitle(f"Premium stats {rider.first_name} {rider.last_name}")
